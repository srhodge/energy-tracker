...
- Enbridge (id=12): ENB, Midstream Pipeline & Processing, $38.75B rev, 12,000 employees, $153.5M WWT addressable (24%; 27%−8%mismatch+5%AI=24%; ms_standardized=false [unconfirmed — cleared 2026-05-16], channel_mismatch=Calgary HQ outside STOLA territory, oem_direct_confirmed=false, ai_maturity≥15 confirmed — high AI bonus applies; denominator=Revenue×0.12=$4.65B) [MEDIUM_HIGH]
...
- LyondellBasell (id=63): LYB, Petrochemical & Specialty Chemicals, $37.7B rev, 26,000 employees, $679.1M WWT addressable (27%; ms_standardized=false [unconfirmed — cleared 2026-05-16], no MSP, no CoE, oem_direct_confirmed=false) [MEDIUM_HIGH]
- Sempra Energy (id=31): SRE, Energy Utilities, $13.185B rev, 16,773 employees, $243.4M WWT addressable (24%; 27%−8%mismatch+5%AI=24%; ms_standardized=false [unconfirmed — cleared 2026-05-16], channel_mismatch=San Diego HQ outside STOLA, no MSP, no CoE, oem_direct_confirmed=false; denominator=Revenue×0.35=$4.61B) [MEDIUM_HIGH]
...
- Sasol (id=244): SSL, Petrochemical & Specialty Chemicals, $13.9B rev, 27,411 employees, $318.0M WWT addressable (19%; 27%−8%mismatch=19%; ms_standardized=false [unconfirmed — cleared 2026-05-16], CIO confirmed, channel_mismatch=Johannesburg HQ, oem_direct_confirmed=false) [MEDIUM_HIGH]
...
- Occidental Petroleum (id=42): OXY, Upstream E&P, $26.72B rev, 12,000 employees, $447.1M WWT addressable (27%; ms_standardized=false [unconfirmed — cleared 2026-05-16], CEO Vicki Hollub, ruthless automation 40% Permian production automated, CrownRock acquisition Aug 2024 IT integration demand, Houston HQ in STOLA, ai_maturity=13) [MEDIUM_HIGH]
...
- Devon Energy (id=66): DVN, Upstream E&P, $16.0B rev, 4,500 employees, $164.1M WWT addressable (19%; 27%−8%mismatch=19%; CTO Trey Lowe confirmed, AI/automation/RPA named as core competencies, Databricks+Azure+SAP HANA confirmed, new CEO Clay Gaspar 2025 + $1B business optimization, channel_mismatch=OKC outside STOLA, ms_standardized=false [unconfirmed — cleared 2026-05-16], ai_maturity=11) [MEDIUM_HIGH]
...
- Kinder Morgan (id=30): KMI, Midstream Pipeline & Processing, $15.1B rev, 10,933 employees, $104.6M WWT addressable (27%; ms_standardized=false [unconfirmed — cleared 2026-05-16], CIO/CAO Michael Pitta, CFO drives GenAI strategy, $5B pipeline backlog for AI data center demand, Houston HQ in STOLA, ai_maturity=10; denominator=Revenue×0.12=$1.81B) [MEDIUM_HIGH]
