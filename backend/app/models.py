...
class CompanySpendEstimate(Base):
    ...
    model_version: Mapped[str | None] = mapped_column(String(10), server_default="v3.1")
    ...
    step4_employee_derived: Mapped[Decimal | None] = mapped_column(Numeric(18, 2))
    step4_scale_factor: Mapped[Decimal | None] = mapped_column(Numeric(8, 4))
    step5_applied: Mapped[bool | None] = mapped_column(Boolean)
    ...
    step7_cyber_flag: Mapped[bool | None] = mapped_column(Boolean)
    step7_esg_multiplier: Mapped[Decimal | None] = mapped_column(Numeric(5, 3))
    step8_ma_uplift: Mapped[Decimal | None] = mapped_column(Numeric(8, 4))
    step8_pivot_count: Mapped[int | None] = mapped_column(Integer)
    ...
    step11_forward_estimate: Mapped[Decimal | None] = mapped_column(Numeric(18, 2))
